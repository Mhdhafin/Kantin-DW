...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        clickAways.each(function () {
            ...
            var elementComponentClass =
                "." + myClasses[myClasses.indexOf("control") - 1] + "-wrapper";

            $(this).addClass("click-away");
            $("#" + elementAriaControls).addClass("click-away");
            if (
                $("#" + elementAriaControls).closest(elementComponentClass) !=
                null
            ) {
                $("#" + elementAriaControls)
                    .closest(elementComponentClass)
                    .addClass("click-away");
            }
        });
        ...
        controls.each(function (element) {
            $(this).on("click", function (event) {
                ...
                var activeComponentClass =
                    "." +
                    myClasses[myClasses.indexOf("control") - 1] +
                    "-wrapper";
